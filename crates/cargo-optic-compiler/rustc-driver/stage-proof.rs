...
//!
//! The compiler unit test builds this standalone callback with the pinned rustc. Paired invocations
//! differ only in temporary-file retention and its directory. Both record the effective session
//! configuration and the complete regular codegen-unit list before code generation.
//!
