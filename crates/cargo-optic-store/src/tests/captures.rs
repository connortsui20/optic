//! Checks publication and completed-history reads through the store boundary.
//!
//! Valid and corrupt layouts cover staging visibility, capture identity, and record decoding.
