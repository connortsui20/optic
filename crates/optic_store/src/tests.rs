...
fn publishes_immutable_records_and_lists_newest_first() {
    ...
    let older = record("cap_00000000000000000000000000000001", 1_000);
    let newer = record("cap_00000000000000000000000000000002", 2_000);
...
fn ignores_staging_and_rejects_invalid_completed_data() {
    ...
    let staged = store
        .root
        .join("staging/cap_00000000000000000000000000000001");
    ...
    let completed_id: CaptureId = "cap_00000000000000000000000000000002"
        .parse()
